...
import com.jasminesystems.metodosordenamiento.entity.Intercalacion;
...
public class IntercalacionController {
    ...
    @FXML private void ordenar(ActionEvent event) {
        try {
            ...
            Intercalacion ic = new Intercalacion();
            array = ic.ordenar(array);
